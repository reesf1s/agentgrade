    ...
    <div className="space-y-6 pb-10">
      ...
      {!hasData ? (
        <GlassCard className="rounded-[1.25rem] p-12 text-center">
          <BarChart3 className="mx-auto mb-4 h-10 w-10 text-fg-muted" />
          <h3 className="text-lg font-semibold text-fg">No benchmark data yet</h3>
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-fg-secondary">
        ...
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(320px,0.8fr)]">
          <GlassCard className="rounded-[1.25rem] p-6">
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-lg font-semibold text-fg">Last 30 days</h2>
              </div>
              <ScoreBadge score={score} size="sm" />
            </div>
            <div className="rounded-2xl border border-edge bg-surface p-5">
              <div className="mb-3 flex items-center justify-between">
                <span className="text-sm font-medium text-fg">Overall quality</span>
          ...
          <GlassCard className="rounded-[1.25rem] p-6">
            <Lock className="mb-3 h-8 w-8 text-fg-muted" />
            <h3 className="text-lg font-semibold text-fg">Industry comparison coming next</h3>
